...
export default function Login() {
  return (
    <div className='flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2'>
      <Link
        href='/'
        className=' left-8 top-8 py-2 px-4 rounded-md no-underline  bg-btn-background hover:bg-btn-background-hover flex items-center group text-sm'
      >
        <svg
      ...
      <form className='flex-1 flex flex-col w-full justify-center gap-2 ' action='/auth/sign-in' method='post'>
        ...
        <button className='bg-green-700 rounded px-4 py-2  mb-2'>Sign In</button>
