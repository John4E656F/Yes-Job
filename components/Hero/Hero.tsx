        ...
        <div className='flex flex-col md:flex-row gap-4 justify-between items-center '>
          <div className=' w-auto flex flex-col gap-4'>
            ...
            <Button
              text={t('cta.publish')}
              btnType='button'
              className=' md:block md:w-auto lg:max-w-xs items-center px-4 h-11 justify-center text-sm bg-brand-primary text-white rounded-lg hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-gray-200 '
