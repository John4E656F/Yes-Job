...
export const Toast: React.FC<ToastProps> = ({ isOpen, onClose, title, message, link }) => {
  ...
  return (
    <dialog
      id='toast'
      className='fixed z-50 bottom-0 right-0 m-4 flex items-center w-fit max-w-md p-4 space-x-4 text-gray-500 bg-white divide-x divide-gray-200 rounded-lg shadow'
    >
